...
export const Appbar = ({pageType, toggle}: AppbarProps) =>{
    ...
    return <>
        <div className="flex flex-row justify-between shadow sticky top-0 z-10 w-full mr-0 bg-background h-15 border-b border-border">
            ...
            <div className="flex justify-around [&>*]:mx-2 items-center pr-2">
                <div id="bell-profile" className={
                    ...
                    <div className="hidden focus:block h-fit w-20 absolute bg-secondary top-10">
                        <div className="h-fit w-gull">
                            <ul className="h-fit">
                                <li>hi</li>
                                <li>hi</li>
                                <li>hi</li>
