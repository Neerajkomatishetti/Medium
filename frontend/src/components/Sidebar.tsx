...
export const Sidebar =() =>{
    ...
    return <>
    <div id="sidebar" className="w-[70vw]  border border-r-border bg-background text-primary md:flex md:flex-col md:items-start md:[&>*]:py-3 md:pl-5 md:pt-10 md:w-[20vw] h-[calc(100vh-60px)]">
                        ...
                        <div className="flex flex-row justify-between w-full px-2">
                            ...
                            <div className="flex flex-col w-[95%] pr-2">
                                <div>Discover more writers and publications to follow.</div>
                                <div>
